        ...
        <div className="container">
          ...
          <div className="row" style={{ paddingBottom: "30px" }}>
            ...
            <div className="col-xs-12 col-sm-12 col-md-6 col-lg-6 flex">
             <div style={{ width: "50%",marginTop: "80px" }} className="flexNullCenter flexColumn">
              ...
              {/* <div style={{ width: "50%" }}> */}
                {/* <div style={{ marginTop: "100px" }}> */}
                    ...
                    <PhoneIcon style={{height:'30px', color:'#D49733', marginTop:'50px'}} />
                    <MapPinIcon style={{height:'30px', color:'#D49733', marginTop:'50px'}} />
                </div>
              {/* </div>  */}
             </div> 
          </div>
